...
correcte=True
print("Comment :=>> ============================================")
print("Comment :=>> INICI TEST PATH DFS                       ==")
print("Comment :=>> ============================================")
print ("Comment :=>>")
print ("Comment :=>>")
...
solucions=[['T1', 'T2', 'T5', 'T8', 'T9', 'T10', 'T11'],
           ['Sants Est.', 'Tarragona', 'Esp.', 'Roc.', 'Urgell', 'Univ.', 'Cat.', 'Urq.', 'Triomf', 'Marina', 'Glòries', 'Clot', 'Bac Roda', 'Sant Martí', 'La Pau', 'Besòs', 'Besòs Mar'],
           ['Tu', 'Maria', 'Jordi', 'Berta', 'Joshua', 'LA persona']]
#solucionsCaronte=["T1 : T2 : T5 : T8 : T11 :",
#                  "Sants Est. : Entença : H. Clínic : Diagonal : Pg. Gràcia : Univ. : St. Ant. : Paral·lel : Drassanes : Liceu : Cat. : Urq. : Jaume I : Barcelone. : Ciutadella : Bogatell : Llacuna : Poblenou : Selva Mar : El Maresme : Besòs Mar :"
#                  "Tu : Jordi : Berta : Joshua : LA persona : "]
punts=[3,4,3]

i=0
for n,r,p in zip(nodes,relacions,pesos):
    print ("Comment :=>> ========================================")
    print ("Comment :=>> Test Path DFS graf:",i, "                ==")
    print ("Comment :=>> ========================================")
    print ("Comment :=>>")
    print("Comment :=>> ============================================")
    print("Comment :=>> CALCULANT GRAF                            ==")
    print("Comment :=>> ============================================")
    ...
    print("Comment :=>> ============================================")
    print ("Comment :=>> Calculant DFS graf:",i,": Node Inicial:",nodeInicial[i])
    visitat, recorregut = g.DFS(nodeInicial[i])
    print("Comment :=>> ============================================")
    print("RECORREGUT: ",recorregut)
    print("Comment :=>> ============================================")
    print("VISITAT: ",visitat)
    print("Comment :=>> ============================================")
    print("Comment :=>> CALCULANT PATH                            ==")
    print("Comment :=>> ============================================")
    print ("Comment :=>> Calculant path DFS graf:",i)
    print ("Comment :=>> : Node Inicial:",nodeInicial[i])
    print ("Comment :=>> : Node Final:",nodeFinal[i])
    p=g.donaPath(nodeInicial[i],nodeFinal[i],visitat)
